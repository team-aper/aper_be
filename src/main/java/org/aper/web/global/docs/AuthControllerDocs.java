...
public interface AuthControllerDocs {
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "400", description = "유효성 검사 실패 (ErrorCode: C002)", content = @Content(schema = @Schema(implementation = ErrorResponseDto.class))),
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "401", description = "엑세스 토큰 만료 (ErrorCode: A006 - 만료된 엑세스 토큰입니다)", content = @Content(schema = @Schema(implementation = ErrorResponseDto.class))),
